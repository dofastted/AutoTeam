...
export const api = {
  ...
  scanRtRecovery: () => request('POST', '/accounts/rt-recovery/scan'),
  markRtRecoveryDeactivated: (body = {}) => request('POST', '/accounts/rt-recovery/mark-deactivated', body),
  startRtRecovery: (body) => request('POST', '/accounts/rt-recovery/start', body),
  startSingleRtRecovery: (email, body = {}) => request('POST', `/accounts/${encodeURIComponent(email)}/rt-recovery`, body),
